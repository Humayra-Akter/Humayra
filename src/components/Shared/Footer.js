      ...
      <div className="footer p-10 bg-neutral text-neutral-content">
        <aside>
          <svg
            ...
            fillRule="evenodd"
            clipRule="evenodd"
            className="fill-current transform transition-transform hover:rotate-12 hover:scale-110 duration-500"
          >
        ...
        <nav>
          ...
          <div className="grid grid-flow-col gap-4">
            {[
              ...
              >
                <i
                  className={`${social.icon} text-secondary text-2xl transform transition-transform duration-500 hover:scale-125 hover:rotate-6`}
                ></i>
              </Link>
            ))}
          </div>
